...
# --- KONFIGURASI CHECKPOINT (UNOPTIMIZE VERSION) ---
CHECKPOINT_DIR = './checkpoints'
CHECKPOINT_PATH = os.path.join(CHECKPOINT_DIR, 'poolformer_cifar100_unoptimize_latest.pth')
BEST_MODEL_PATH = os.path.join(CHECKPOINT_DIR, 'poolformer_cifar100_unoptimize_best.pth')
METRICS_PATH = os.path.join(CHECKPOINT_DIR, 'training_metrics_unoptimize.json')
...
def main():
    ...
    print(f"   - Untuk training ulang dari awal, gunakan: python run_experiment.py --reset")
    print("=" * 60)
